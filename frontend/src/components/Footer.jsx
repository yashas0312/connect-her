      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">ConnectHer</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering women through storytelling and entrepreneurship. 
              Join our community to share your journey, discover amazing businesses, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/businesses" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Find Businesses
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-300">
                Get the latest stories and business spotlights delivered to your inbox.
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 ConnectHer. All rights reserved.
          </p>
